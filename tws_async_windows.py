...
class TWSClient(EClient):
    ...
    def connect(self, loop, host, port, clientId):
        self.host = host
        self.port = port
...
class TWSSocket(asyncio.Protocol):
    ...
    def connection_lost(self, exc):
        print('Connection lost', exc, self.transport)
...
if __name__ == '__main__':
    ...
    tws = TWS()
    tws.connect(loop, host='localhost', port=7496, clientId=1)
